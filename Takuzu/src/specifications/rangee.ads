...
package Rangee is
   ...
   -- retourne le chiffre de droite de coordonnée i de la Rangee r
   -- necessite 0 < i <= taille(r)
   -- leve l'exception TRANCHE_INVALIDE si i < 1 ou i > taille(r)
   function chiffreDeDroite
     (R : in Type_Rangee; I : in Integer) return Type_Chiffre;

   -- retourne le chiffre de gauche de l'indice i de la rangee r
   -- necessite 0 < i <= taille(r)
   -- leve l'exception TRANCHE_INVALIDE si i < 1 ou i > taille(r)
   function chiffreDeGauche
     (R : in Type_Rangee; I : in Integer) return Type_Chiffre;

   -- retourne VRAI si les deux chiffres de droite
   -- l'indice i de la rangee r sont égaux et FAUX sinon
   -- necessite 0 < i <= taille(r)
   -- leve l'exception TRANCHE_INVALIDE si i < 1 ou i > taille(r)
  function SontDeuxChiffresDeDroiteEgaux
     (R : in Type_Rangee; I : in Integer) return Boolean;

   -- retourne VRAI si les deux chiffres de gauche
   -- l'indice i de la rangee r sont égaux et FAUX sinon
   -- necessite 0 < i <= taille(r)
   -- leve l'exception TRANCHE_INVALIDE si i < 1 ou i > taille(r)
